...
def main():
    ...
    for algorithm_name in ALGORITHMS_List:
        ...
        if algorithm_name not in ALGORITHMS:
            logger.warning(f"算法{algorithm_name}无对应的训练函数，跳过")
            continue
    ...
    logger.info(f"耗时{(end_time - start_time) // 60} min")
